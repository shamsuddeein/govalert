...
def get_main_menu_keyboard() -> dict:
    return _build_keyboard([
        [{'text': 'Browse Jobs', 'data': 'show_jobs'}, {'text': 'Agencies', 'data': 'show_agencies'}],
        [{'text': 'My History', 'data': 'show_history'}, {'text': 'Settings', 'data': 'show_settings'}],
    ])
...
def get_alert_keyboard(alert_id: int) -> dict:
    return _build_keyboard([
        [
            ...
            {'text': 'Report Fake', 'data': f'report_alert:{alert_id}'},
...
def get_settings_keyboard() -> dict:
    return _build_keyboard([
        ...
        [{'text': 'Delete My Data', 'data': 'settings_delete_data'}],
    ])


def get_start_keyboard() -> dict:
    return _build_keyboard([
        [{'text': 'Manage Subscriptions', 'data': 'show_settings'}],
    ])
...
def get_onboarding_keyboard() -> dict:
    return _build_keyboard([
        [
            {'text': 'Customize Alerts', 'data': 'show_settings'},
...
def get_report_reason_keyboard(alert_id: int) -> dict:
    return _build_keyboard([
        ...
        [{'text': 'Not from official source', 'data': f'report_reason:{alert_id}:NOT_OFFICIAL'}],
